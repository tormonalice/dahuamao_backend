if (typeof Config.upload.storage !== 'undefined' && Config.upload.storage === 'alioss') {
    require(['upload'], function (Upload) {
        ...
        var getFileMd5 = function (file, cb) {
            ...
            require(['../addons/uploads/js/spark'], function (SparkMD5) {
        ...
        Upload.events.onInit = function () {
            ...
            $.extend(this.options, {
                ...
                chunksUploaded: function (file, done) {
                    var that = this;
                    Fast.api.ajax({
                        url: "/addons/uploads/alioss/upload",
                        data: {
                            action: 'merge',
                            filesize: file.size,
                            filename: file.name,
                ...
                try {
                    ...
                    if (file.xhr.status === 200) {
                        if (Config.upload.uploadmode === 'client') {
                            ...
                            Fast.api.ajax({
                                url: "/addons/uploads/alioss/notify",
            ...
            this.on("addedfile", function (file) {
                ...
                setTimeout(function () {
                    ...
                    getFileMd5(file, function (md5) {
                        ...
                        Fast.api.ajax({
                            url: "/addons/uploads/alioss/params",
