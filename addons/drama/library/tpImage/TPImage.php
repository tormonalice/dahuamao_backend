...
namespace addons\drama\library\tpImage;

use addons\drama\library\tpImage\src\Exception as ImageException;
use addons\drama\library\tpImage\src\gif\Gif;
...
class TPImage
{
     ...
     * @return $this
     */
    public function save($pathname, $type = null, $quality = 90, $interlace = true)
    {
        //自动获取图像类型
        if (is_null($type)) {
            $type = $this->info['type'];
