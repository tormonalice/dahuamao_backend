...
class Addon extends Backend
{
    ...
    /**
     * 更新插件
     * http://www.fast.com/admin.php/addon/upgrade
     * name=example&uid=54723&token=92a4c243-6360-4dec-ada9-a0c075a68395&version=1.1.2&faversion=1.3.4.20220530
     */
    ...
    public function downloaded()
    {
        ...
        if($djdy == 0){
            $list[] = ['title'=>'抖音小程序','intro'=>'抖音小程序插件，集合抖音小程序登录、抖音支付宝微信支付、抖音媒资管理等功能 ','author'=>'author','price'=>'无','anzhuang'=>1];
        }
        $total = count($list);
        if ($limit) {
