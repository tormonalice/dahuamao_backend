 ...
 * @icon fa fa-circle-o
 */
class Reseller extends Backend
{
    ...
    /**
     * Reseller模型对象
     * @var \app\admin\model\drama\Reseller
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\drama\Reseller;
    ...
    public function sync(){
        $testdata_file = ADDON_PATH . "drama" . DS . 'testdata' . DS . "reseller.php";
