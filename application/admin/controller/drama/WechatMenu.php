 ...
 * @icon fa fa-circle-o
 */
class WechatMenu extends Backend
{

    /**
     * Wechat模型对象
     * @var \app\admin\model\drama\Wechat
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\drama\Wechat;
    }
    ...
    public function copy($id)
    {
        ...
        $menu = new \app\admin\model\drama\Wechat;
    ...
    {
        $wechat = new \addons\drama\library\Wechat('wxOfficialAccount');
        try {
    ...
    {
        $drama = \app\admin\model\drama\Config::get(['name' => 'drama', $this->dataLimitField=>$this->auth->id]);
        $drama = $drama ? json_decode($drama->value, true) : ['domain'=>''];
        $wxMiniProgram = \app\admin\model\drama\Config::get(['name' => 'wxMiniProgram', $this->dataLimitField=>$this->auth->id]);
        $wxMiniProgram = $wxMiniProgram ? json_decode($wxMiniProgram->value, true) : ['app_id'=>''];
        $this->assignconfig('drama', $drama);
