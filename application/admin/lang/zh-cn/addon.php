...
return [
    ...
    'Online store'                                            => '在线商店',
    'Local addon'                                             => '本地插件',
    'Conflict tips'                                           => '此插件中发现和现有系统中部分文件发现冲突！请备份好相关文件后再继续操作',
    ...
    'Upgrade tips'                                            => '确认升级<b>《%s》</b>？<p class="text-danger">1、请务必做好代码和数据库备份！备份！备份！<br>2、升级后如出现冗余数据，请根据需要移除即可!<br>3、不建议在生产环境升级，请在本地完成升级测试<br>4、运营用户建议保持稳定版，等新版本稳定后再升级！！！</p>如有重要数据请备份后再操作！',
