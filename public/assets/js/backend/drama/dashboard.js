requirejs.config({
	paths: {
		// vue: "/assets/addons/drama/libs/vue",
		g2: "/assets/addons/drama/libs/antv"
	}
});
	...
	var Controller = {
			...
			var vueChart = new Vue({
				...
				data() {
					return {
						...
						ringRightData: [
							//{ item: 'PayPal支付', type: 'paypalPay', count: 0, percent: 0 },
							{ item: '微信', type: 'wechatPay', count: 0, percent: 0 },
				...
				methods: {
							...
							success: function (res, ret) {
								...
								that.ringRightData.forEach(p => {
									if (p.type != 'otherPay') {
										...
										p.count = data.allTypePay - data.wechatPay;
					...
					goDetail(id) {
						...
						switch (id) {
							case 1:
								url = 'drama/reseller_order';
								break;
							case 2:
								url = 'drama/usable_order';
								break;
							case 4:
								url = 'drama/reseller_log';
								break;
							case 5:
								url = 'drama/vip_order';
								break;
							case 6:
								url = 'drama/user_wallet_apply?datetimerange=' + times;
								break;
						}
		...
		recyclebin: function () {
			...
			table.bootstrapTable({
				url: 'drama/decorate/recyclebin' + location.search,
				pk: 'id',
				sortName: 'id',
				columns: [
					[
