define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/video_view/index' + location.search,
                    //add_url: 'drama/video_view/add',
                    //edit_url: 'drama/video_view/edit',
                    //del_url: 'drama/video_view/del',
                    multi_url: 'drama/video_view/multi',
                    //import_url: 'drama/video_view/import',
                    table: 'drama_video_view',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'title', title: __('Video.title'), operate: 'LIKE'},
                        /*
                        ...
                        */
                        {field: 'index_total_user', title: '首页点击用户量'},
                        {field: 'index_total_user_view', title: '首页用户点击量'},
                        {field: 'index_total_visitor_view', title: '首页游客点击量'},
                        {field: 'index_total_view', title: '首页总点击量'},
                        {field: 'zhui_total_user', title: '追剧页点击用户量'},
                        {field: 'zhui_total_user_view', title: '追剧页用户点击量'},
                        //{field: 'zhui_total_visitor_view', title: '追剧页游客点击量'},
                        //{field: 'zhui_total_view', title: '追剧页总点击量'},
                        {field: 'sou_total_user', title: '搜索页点击用户量'},
                        {field: 'sou_total_user_view', title: '搜索页用户点击量'},
                        {field: 'sou_total_visitor_view', title: '搜索页游客点击量'},
                        {field: 'sou_total_view', title: '搜索页总点击量'},
                        /*
