define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/mgg/index' + location.search,
                    //add_url: 'drama/mgg/add',
                    edit_url: 'drama/mgg/edit',
                    //del_url: 'drama/mgg/del',
                    multi_url: 'drama/mgg/multi',
                    import_url: 'drama/mgg/import',
                    table: 'drama_mgg',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'drama/mgg/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
