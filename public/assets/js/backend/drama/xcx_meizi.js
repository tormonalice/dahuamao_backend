    ...
    var Controller = {
            ...
            var videoIndex = new Vue({
                ...
                methods: {
                    ...
                    reqVideoChangePrice() {
                        ...
                        Fast.api.ajax({
                            url: 'drama/xcx_meizi/changePrice',
                            loading: false,
                            type: 'POST',
                            data: {
                    ...
                    copyMsg(id) {
                        ...
                        if (id) {
                            that.$confirm('此操作将复制短剧的页面链接, 是否继续?', '提示', {
                                ...
                                Fast.api.ajax({
                                    url: 'drama/xcx_meizi/episodes/ids/' + id,
                                    loading: true,
                                    type: 'POST',
                                }, function (ret, res) {
                                    console.log(ret);
                    ...
                    videoOpt(type, id) {
                        ...
                        switch (type) {
                            case 'create':
                                Fast.api.open('drama/xcx_meizi/add', '新增短剧', {
                                    callback() {
                                        that.getData();
                                    }
                                })
                                break;
                            case 'edit':
                                Fast.api.open('drama/xcx_meizi/edit/ids/' + id + "?id=" + id + "&type=edit", '编辑短剧', {
                                    callback() {
                                        that.getData();
                                    }
                                })
                            ...
                            case 'del':
                                ...
                                if (ids) {
                                    that.$confirm('此操作将删除短剧, 是否继续?', '提示', {
                                        ...
                                        Fast.api.ajax({
                                            url: 'drama/xcx_meizi/del/ids/' + ids,
                                            loading: true,
                                            type: 'POST',
                                        }, function (ret, res) {
                                            that.getData();
                                ...
                                break;
                            case 'copy':
                                Fast.api.open('drama/xcx_meizi/edit/ids/' + id + "?id=" + id + "&type=copy", '短剧详情', {
                                    callback() {
                                        that.getData();
                                    }
                                })
                            ...
                            case 'clear':
                                ...
                                break;
                            case 'recycle':
                                Fast.api.open('drama/xcx_meizi/recyclebin', '查看回收站')
                                break;
                            default:
                                Fast.api.open('drama/xcx_meizi/edit/ids/' + type.id + "?id=" + type.id + "&type=edit", '编辑短剧', {
                                    callback() {
                                        that.getData();
                                    }
                                })
                    ...
                    videoDownload(){
                        this.$confirm('下载批量导入短剧剧集模板?', '提示', {
                            ...
                            window.open('xcx_meizi/download', '_blank');
                            return false;
                        }).catch(() => {
                            this.$message({
                                type: 'info',
                    ...
                    editStatus(id, type) {
                        let that = this;
                        Fast.api.ajax({
                            url: `drama/xcx_meizi/setStatus/ids/${id}/status/${type}`,
                            loading: true,
                        }, function (ret, res) {
                            that.getData();
                            return false;
        ...
        recyclebin: function () {
            ...
            table.bootstrapTable({
                url: 'drama/xcx_meizi/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
            ...
            var videoDetail = new Vue({
                ...
                methods: {
                    ...
                    getEditData() {
                        let that = this;
                        Fast.api.ajax({
                            url: 'drama/xcx_meizi/detail/ids/' + that.editId,
                            loading: true,
                        }, function (ret, res) {
                        ...
                        this.$refs[formName].validate((valid) => {
                            if (valid) {
                                ...
                                if (that.editId && that.type == 'edit') {
                                    Fast.api.ajax({
                                        url: 'drama/xcx_meizi/edit/ids/' + that.editId,
                                        loading: true,
                                        data: {
                                            row: arrForm,
                                            other: {
