define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/task/index' + location.search,
                    add_url: 'drama/task/add',
                    edit_url: 'drama/task/edit',
                    del_url: 'drama/task/del',
                    multi_url: 'drama/task/multi',
                    import_url: 'drama/task/import',
                    table: 'drama_task',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'drama/task/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
