define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/reseller_order/index' + location.search,
                    add_url: 'drama/reseller_order/add',
                    edit_url: 'drama/reseller_order/edit',
                    del_url: 'drama/reseller_order/del',
                    multi_url: 'drama/reseller_order/multi',
                    import_url: 'drama/reseller_order/import',
                    table: 'drama_reseller_order',
                }
            });
                ...
                columns: [
                    [
                        ...
                        {field: 'reseller_id', title: __('Reseller_id'),
                            visible: false,
                            addclass: 'selectpage',
                            extend: 'data-source="drama/reseller/index" data-field="name"',
                            operate: '=',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'drama/reseller_order/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'drama/reseller_order/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'drama/reseller_order/destroy',
                                    refresh: true
                                }
                            ],
