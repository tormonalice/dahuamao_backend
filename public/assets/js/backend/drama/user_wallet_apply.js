            ...
            var userWalletApply = new Vue({
                ...
                methods: {
                    getType() {
                        var that = this;
                        Fast.api.ajax({
                            url: 'drama/user_wallet_apply/getType',
                            loading: true,
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    getWalletApply(offset = 0, limit = 10) {
                        ...
                        // return false;
                        Fast.api.ajax({
                            url: 'drama/user_wallet_apply/index',
                            loading: true,
                            type: 'GET',
                            data: {
                    ...
                    reqApplyOper(row, status, status_msg) {
                        ...
                        Fast.api.ajax({
                            url: `drama/user_wallet_apply/handle/ids/${ids}`,
                            loading: true,
                            type: 'POST',
                    ...
                    openUser(id) {
                        Fast.api.open('drama/user/user/profile?id=' + id, '查看')
                    },
                    openLogDialog(id) {
                        let that = this;
                        Fast.api.ajax({
                            url: `drama/user_wallet_apply/log?id=${id}`,
                            loading: true,
                            type: 'GET',
                        }, function (ret, res) {
