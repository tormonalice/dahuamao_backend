define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/episodes_view/index' + location.search,
                    //add_url: 'drama/episodes_view/add',
                    //edit_url: 'drama/episodes_view/edit',
                    //del_url: 'drama/episodes_view/del',
                    multi_url: 'drama/episodes_view/multi',
                    import_url: 'drama/episodes_view/import',
                    table: 'drama_episodes_view',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'name', title: __('Episodes.name'), operate: 'LIKE'},
                        {field: 'total_user', title: __('Total_user')},
                        {field: 'total_user_view', title: __('Total_user_view')},
                        {field: 'total_visitor_view', title: __('Total_visitor_view')},
                        {field: 'total_view', title: __('Total_view')},
                        /*
