define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'drama/usable_order/index' + location.search,
                    add_url: 'drama/usable_order/add',
                    edit_url: 'drama/usable_order/edit',
                    del_url: 'drama/usable_order/del',
                    multi_url: 'drama/usable_order/multi',
                    import_url: 'drama/usable_order/import',
                    table: 'drama_usable_order',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'usable_id', title: __('Usable_id'),
                            visible: false,
                            addclass: 'selectpage',
                            extend: 'data-source="drama/usable/index" data-field="title"',
                            operate: '=',
                        ...
                        {field: 'usables.title', title: __('积分套餐'), operate: 'LIKE'},
                        {field: 'usable', title: __('充值积分')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'drama/usable_order/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'drama/usable_order/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'drama/usable_order/destroy',
                                    refresh: true
                                }
                            ],
